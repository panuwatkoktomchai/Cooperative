...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">โลโก้</span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    <div class="w3-container">
        ...
        <p><a href="profile/edit">แก้ใข</a></p>
        <hr>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i>  การผลิต</a>
    <a href="/setting" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-fw"></i>  จัดการข้อมุลพื้นฐาน</a><br><br>
  </div>
</nav>
