  ...
  <?php if($_SESSION['user']['user_type'] == 1 ) { ?>
    <button onclick="myFunction('Demo1')" class="w3-btn w3-block w3-light-gray w3-left-align w3-hover-blue-gray"> <i class="fa fa-list"></i> การผลิต </button>
      <div id="Demo1" style="padding-left:20px" class="w3-hide">
        <a href="/cooper/view/orderMaterial/list.php" class="w3-bar-item w3-button w3-padding"><i class="w3-text-orange fa fa-file-text fa-fw"></i>  สั่งซื้อวัสดุ</a>
        ...
        <a href="/cooper/view/produce/list.php" class="w3-bar-item w3-button w3-padding"><i class="w3-text-orange fa fa-legal fa-fw"></i>  สั่งผลิต</a>
        <a href="/cooper/view/reciveProducts/form.php" class="w3-bar-item w3-button w3-padding"><i class="w3-text-orange fa fa-legal fa-fw"></i>  บันทึกการผลิต</a>
        <a href="/cooper/view/deliver/list.php" class="w3-bar-item w3-button w3-padding"><i class="w3-text-orange fa fa-truck fa-fw"></i>  ส่งสินค้า</a>
      </div>
