...
<header class="w3-container" style="padding-top:22px">
        <h5 class="w3-left"><b><i class="fa fa-user-circle"></i>รายการที่เลือก</b></h5>
        ...
        <div class="w3-container w3-padding">
            ...
            <h3><i class="w3-xlarge fa fa-info-circle"></i> รายการที่เลือก</h3>
                <table class="w3-table w3-margin">
                    ...
                    <i class="w3-text-green fa fa-check-square"></i> = สินค้าพอสำหรับขาย |
                    <i class="w3-text-red fa fa-times-circle"></i> = สินค้าไม่พอสำหรับขาย
                    <tbody>
                        <?php if(array_key_exists('pos',$_SESSION)) { ?>
                        <?php foreach($_SESSION['pos'] as $key=>$value){ 
                            $total = $total+ ($value['price']* $value['amount']);
                            if ($value['amount'] < $value['add']) {
                        ...
                        <tr>
                            ...
                            <td><i class="w3-text-<?php echo $color ?> fa <?php echo $icon ?>" aria-hidden="true"> </i> <?php echo $value['add'] ?></td>
                            <td>
                ...
                <div>
                    <strong style="border-bottom: 3px double;">ราคารวม <?php echo $total ?> บาท</strong> 
                </div>
                <br>
            </div>
            <?php if($pos) { ?>
            ...
            <?php }else{ ?>
            <button class="w3-button w3-round" disabled >สินค้าบายรายการจำนวนไม่พอ</button>
            <?php } ?>
