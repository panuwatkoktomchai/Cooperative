...
<header class="w3-container" style="padding-top:22px">
        <h5 class="w3-left"><b><i class="fa fa-user-circle"></i> ขายสินค้า</b></h5>
        ...
        <div class="w3-container w3-padding">
            ...
            <table id="datableCustomer"  class="display">
                ...
                <?php foreach ($materials as $key=>$value) {?>
                    <tr class="w3-center">
                        <td><input <?php echo isset( $_SESSION['pos'][$value['id']]) ? "checked" : "" ?> type="checkbox" class="w3-check" name="<?php echo $value['id'] ?>"> </td>
                        <td><input type="number" required class="w3-input w3-border" <?php echo isset($_SESSION['pos'][$value['id']]) ? "" : "disabled" ?> name="data[<?php echo $value['id'] ?>]" id="<?php echo $value['id'] ?>" value="<?php echo $_SESSION['pos'][$value['id']]['add'] ?>"></td>
