...
$status = ['ยังไม่ผลิต','ผลิตเสร็จแล้ว','ยังไม่จ่ายชำระเงิน','จ่ายชำาระแล้ว','ส่งสินค้าแล้ว','ยังไม่ส่งสินค้า'];
...
<body  class="w3-padding" style="margin-top:50px">
    <div class="w3-border" id="content">
        ...
        <div class="w3-row w3-margin">
            <div class="w3-col m3 w3-border w3-padding">
                <p>
                    <strong>รหัสสั่งผลิต</strong> <?php echo $_GET['id'] ?>
                </p>
                <p>
            ...
            <table class="w3-table-all w3-border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="w3-right"><i class="w3-text-green fa fa-plus" aria-hidden="true"> </i> <?php echo $value['amount_order'] ?></td> 
                    </tr>
                    <?php } ?>
                    <tr>
    ...
    <div class="w3-padding">
        <button onclick="printDocument()" class="w3-button w3-green"> ปริ้นใบสั่งผลิต</button>
