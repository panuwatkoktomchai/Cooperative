...
<?php
    ...
    $strGet = "select * from users ";
    $customer = $conn->query($strGet);
    $status = ['ผู้ดูแลระบบ','สมาชิกสหกรณ์','ลูกค้า'];
?>
...
<header class="w3-container" style="padding-top:22px">
        <h5 class="w3-left"><b><i class="fa fa-user-circle"></i> ข้อสมาชิก</b></h5>
    ...
    <div class="w3-card w3-round w3-white">
        ...
        <table id="datableCustomer"  class=" display">
            ...
            <tr class="w3-center">
                ...
                <td><?php echo $status[$value['user_type']] ?></td>
                <td>
            ...
            <div id="<?php echo $value['id'] ?>" class="w3-modal w3-round">
                ...
                <div class="w3-container w3-center">
                    <p>ต้องการลบข้อมูล คุณ <?php echo $value['firstname'].' '.$value['lastname'] ?> หรือไม่ ?</p>
                </div>
                <footer class="w3-container w3-light-gray w3-center">
                    <p>
                        <a href="code/delete.php?id=<?php echo $value['id'] ?>&file=<?php echo $value['image'] ?>" class="w3-button w3-red w3-round-large">ยืนยัน</a>
