...
$sql = "select order_material.*, users.name from order_material join users on order_material.user_id = users.id";
$data = $conn->query($sql);
?>
<!DOCTYPE html>
<html>
...
<header class="w3-container" style="padding-top:22px">
        <h5 class="w3-left"><b><i class="fa fa-file-text-o"></i> รายงานการสั่งซื้อวัสดุ </b></h5>
                    ...
                    <tbody>
                        <?php foreach($data as $key=>$value) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="w3-button w3-round w3-blue" href="printOrder.php?id=<?php echo $value['id'] ?>">รายละเอียดการสั่งซื้อวัสดุ</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
