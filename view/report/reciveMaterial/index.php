...
$sql = "select order_material.*, users.name from order_material join users on order_material.user_id = users.id where order_status = 1";
$data = $conn->query($sql);
?>
<!DOCTYPE html>
<html>
                    ...
                    <tbody>
                        <?php foreach($data as $key=>$value) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="w3-button w3-round w3-blue" href="../orderMaterial/printOrder.php?id=<?php echo $value['id'] ?>">รายละเอียด</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
