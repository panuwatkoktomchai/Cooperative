...
<?php
    ...
    $strGet = "select materials.*, equiments.title as materialtype_name from materials left join equiments on materials.equiment_id = equiments.id";
    ...
    <div class="w3-card w3-round w3-white">
        ...
        <thead>
            ...
            <td><?php echo $key+1  ?></td>
                ...
                <td><?php echo $value['materialtype_name'] ?></td>
                <td>
