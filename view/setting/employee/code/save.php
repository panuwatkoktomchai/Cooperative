...
$strInsert = "insert into employee (id, firstname, lastname, phone, address, birthday, created_at, updated_at)".
            " value(null, '".$data['firstname']."', '".$data['lastname']."', '".$data['phone']."', '".$data['address']."', '".$data['birthday']."', '".$created_at."', '".$created_at."')";
