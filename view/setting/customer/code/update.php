...
if ($_FILES['filUpload']['name']!='') {
    ...
    $sqlUpdate = "update customers set firstname = '".$data['firstname']."', lastname = '".$data['lastname']."', phone = '".$data['phone']."', address = '".$data['address']."', birthday = '".$data['birthday']."', image = '".$image."'";
}else {
    $sqlUpdate = "update customers set firstname = '".$data['firstname']."', lastname = '".$data['lastname']."', phone = '".$data['phone']."', address = '".$data['address']."', birthday = '".$data['birthday']."'";
}
