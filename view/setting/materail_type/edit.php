...
<?php
    ...
    $sqlGet = "select * from equiments where id =".$_REQUEST['id'];
    $equiments = $conn->query($sqlGet);
    $data = $equiments->fetch_assoc();
?>
<!DOCTYPE html>
<html>
        ...
        <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
                <form action="code/update.php?id=<?php echo $data['id'] ?>" method="post"> 
                    <p>
                        <h2>ชื่อ</h2>
                        <input value="<?php echo $data['title'] ?>" type="text" required name="data[title]" class="w3-input" placeholder="กรอกชื่อวัสดุ" >
                    </p>
