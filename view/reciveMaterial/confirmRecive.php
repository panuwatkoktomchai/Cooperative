...
<body class="w3-padding">
    ...
    <p class="w3-center"> 
        <a class="w3-button w3-green" href="code/submitRecive.php?id=<?php echo $order['id'] ?>" >บันทึกการรับสินค้า</a>  <a class="w3-button w3-red" onclick="window.history.go(-1)">ย้อนกลับ</a>
    </p>
</body>
</html>
<script>
